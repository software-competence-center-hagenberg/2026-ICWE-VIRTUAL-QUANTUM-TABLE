...
* **`src`** Source files
  * **`v0`** The first version of the **Virtual Quantum Table** was generated using the `gpt-5.1-codex` model using `Prompts/1-DEVELOPER.md` and `Prompts/Quantum-Table.jpg`. The file `styles.css` contains 19 additional lines of CSS code that resolve layout bugs.
